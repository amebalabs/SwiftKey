...
struct SnippetsSettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("Got a useful configuration? Share it with the community by submitting a pull request to the snippets repository.")
                .lineLimit(nil)
            
            Link("Learn How to Share Snippets", destination: URL(string: "https://github.com/amebalabs/swiftkey-snippets")!)
                .padding(.top, 5)
